...
<div style="text-align:center"> 
  ...
  <video id="{video_id}" width="110">
    <source src="http://172.10.20.61:8080/video4271/{video_id}.mp4" type="video/mp4">
...
<img class="text-center" src="http://172.10.20.61:8080/image4271/{file_path_name}.png" height="60%" width="60%" />
</div></td>
